...
public static class Vectors
{
    ...
    /// <summary>
    /// Devuelve 'point' clamped a una distancia m�xima desde 'origin'.
    /// Si ya est� dentro, se devuelve tal cual.
    /// </summary>
    ...
    // Proyecci�n de un vector sobre un plano (equivalente a Vector3.ProjectOnPlane)
